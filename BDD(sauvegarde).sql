...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 13 fév. 2021 à 16:53
...
--
ALTER TABLE `contact`
  ADD CONSTRAINT `contact_users_FK` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`);

--
-- Contraintes pour la table `livre`
--
ALTER TABLE `livre`
  ADD CONSTRAINT `livre_auteur_FK` FOREIGN KEY (`id_auteur`) REFERENCES `auteur` (`id`),
  ADD CONSTRAINT `livre_users0_FK` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`);
COMMIT;
